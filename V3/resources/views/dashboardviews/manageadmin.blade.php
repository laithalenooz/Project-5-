          ...
          <thead>
            <tr>
                ...
                <tr>
                  ...
                  <td>{{$value->name}}</td>
                  <td>{{$value->email}}</td>
                  <td><a href="manageadmin/{{$value->id}}/edit"> <button type="button" class="btn btn-warning">Edit</button></a></td>
                  <td><a href="manageadmin/{{$value->id}}/delete"><button type="button" class="btn btn-danger">Delete</button></a>
                  </td>
